export const reg = {
    ...
    password:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])([A-Za-z\d$@$!%*?&]|[^ ]){8,15}$/g,
}

export const error = {
    text:'The user must be more than two characters long',
    email:'The email is incorrect',
    password:'the password must contain letters, a capital letter, a special character and numbers',
}